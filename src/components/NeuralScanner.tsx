...
export default function NeuralScanner() {
  return (
    <div className="flex items-center gap-4 bg-[var(--bg-surface)]/50 border border-[var(--border-subtle)] p-3 rounded-2xl backdrop-blur-md relative overflow-hidden group">
      ...
      <div className="flex flex-col pr-4">
        <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[var(--text-muted)] italic leading-none">
          Live Connection
        </span>
        <span className="font-mono font-black text-sm text-[var(--text-primary)] tracking-tighter uppercase italic mt-1 flex items-center gap-2">
          NEURAL_LINK
          <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,217,129,0.8)] animate-pulse" />
        </span>
      </div>
    </div>
  );
